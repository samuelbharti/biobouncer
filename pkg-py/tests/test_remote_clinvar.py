...
def test_existing_accession_is_valid(monkeypatch):
    ...
    res = biogate.check_id("VCV000012345", source_db="clinvar", how="remote")[0]
...
def test_absent_accession_is_invalid(monkeypatch):
    ...
    res = biogate.check_id("VCV999999999", source_db="clinvar", how="remote")[0]
...
def test_malformed_skips_the_network(monkeypatch):
    ...
    res = biogate.check_id("VCV12345", source_db="clinvar", how="remote")[0]
    assert res.valid is False
    assert res.suggestion is None
...
def test_unexpected_status_raises_and_is_not_cached(monkeypatch):
    ...
    with pytest.raises(RemoteError):
        biogate.check_id("VCV000012345", source_db="clinvar", how="remote")
