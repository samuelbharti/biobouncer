...
def test_existing_sequence_is_valid(monkeypatch):
    ...
    res = biogate.check_id("UPI0000000001", source_db="uniparc", how="remote")[0]
...
def test_absent_sequence_is_invalid(monkeypatch):
    ...
    res = biogate.check_id("UPI0000000000", source_db="uniparc", how="remote")[0]
...
def test_malformed_skips_the_network(monkeypatch):
    ...
    res = biogate.check_id("UPI000000000G", source_db="uniparc", how="remote")[0]
    assert res.valid is False
    assert res.suggestion is None
...
def test_unexpected_status_raises_and_is_not_cached(monkeypatch):
    ...
    with pytest.raises(RemoteError):
        biogate.check_id("UPI0000000001", source_db="uniparc", how="remote")
