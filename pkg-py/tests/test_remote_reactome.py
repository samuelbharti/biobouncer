...
def test_existing_stable_id_is_valid(monkeypatch):
    ...
    res = biobouncer.check_id("R-HSA-68886", source_db="reactome", how="remote")[0]
...
def test_absent_stable_id_is_invalid(monkeypatch):
    ...
    res = biobouncer.check_id("R-HSA-99999999", source_db="reactome", how="remote")[0]
...
def test_malformed_skips_the_network(monkeypatch):
    ...
    res = biobouncer.check_id("R-HSA-XYZ", source_db="reactome", how="remote")[0]
    assert res.valid is False
    assert res.suggestion is None
...
def test_unexpected_status_raises_and_is_not_cached(monkeypatch):
    ...
    with pytest.raises(RemoteError):
        biobouncer.check_id("R-HSA-68886", source_db="reactome", how="remote")
