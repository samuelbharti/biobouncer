...
test_that(".remote_workers reads BIOBOUNCER_REMOTE_WORKERS", {
  withr::local_envvar(BIOBOUNCER_REMOTE_WORKERS = "")
  expect_identical(.remote_workers(), 1L)
  withr::local_envvar(BIOBOUNCER_REMOTE_WORKERS = "8")
  expect_identical(.remote_workers(), 8L)
  withr::local_envvar(BIOBOUNCER_REMOTE_WORKERS = "0")
  expect_identical(.remote_workers(), 1L)
  withr::local_envvar(BIOBOUNCER_REMOTE_WORKERS = "junk")
  expect_identical(.remote_workers(), 1L)
})
